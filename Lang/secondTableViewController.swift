...
import UIKit
import Loki
protocol SecondViewController: class{
    func passLanguageValue(value:String)
}

class secondTableViewController: UITableViewController {
    var langArray:Array<LKLanguage> = []
    ...
    override func viewDidLoad() {
        ...
        langArray = LKManager.sharedInstance().languages as! Array<LKLanguage>
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.passLanguageValue(value: currentCell.textLabel!.text!)
